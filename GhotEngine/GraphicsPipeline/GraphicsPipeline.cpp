...
void GraphicsPipeline::CreatePipeline(PipelineState& pso) {
	...
	pso.PostEffectTest = CreatePostEffectTest(device.Get(), L"PostEffectTest");
...
/// <param name="shaderName"></param>
/// <returns></returns>
Property GraphicsPipeline::CreatePostEffectTest(Microsoft::WRL::ComPtr<ID3D12Device> device, const std::wstring& shaderName)
{
	Property property;
